...
import TopicsBag from '../assets/TopicsFemale.png';
    ...
    return (
        <div className="container topics-container">
            <div className="position-relative">
                <div className="row mt-5 text-center">
                    ...
                    <p className="lead mx-auto" style={{maxWidth: "800px"}}>
                        Choose a specialty to focus your exam preparation
                    </p>
                </div>
            </div>
                ...
                <div className="row g-4">
                    ...
                    <div className="col-md-4">
                        <div className="topic-card-square card rounded-4 p-5 border-1 shadow mb-4">
                            ...
                            <p className="card-text text-muted mb-4 mt-2">Topics covered:</p>
                            <ul>
                            ...
                            <button className="topic-button w-100 p-2 d-flex align-items-center justify-content-center"
                    ...
                    <div className="col-md-4 position-relative">
                        <img
                            src={TopicsBag}
                            alt="Medical Topics Image"
                            className="topics-bag-image-on-card"
                        />
                        <div className="topic-card-square card rounded-4 p-5 border-1 shadow mb-4">
                            <div className="card-title fs-4 d-flex mb-3">
            ...
            <div className="text-center mt-4">
                <p className="lead mx-auto" style={{ maxWidth: "800px" }}>
                    Each quiz is structured to reflect real PLAB-style questions, helping you identify knowledge gaps, build confidence, and prepare more effectively for your PLAB exam success.
                </p>
            </div>
        </div>
    );
